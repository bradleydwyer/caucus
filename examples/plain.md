...
2) **Cost-push inflation (higher input costs):** Key costs (energy, food commodities, wages, shipping, taxes/regulation) rise; firms raise prices to protect margins—especially when productivity doesn't keep up with wage growth.

3) **Supply shocks / bottlenecks:** Wars, pandemics, disasters, trade disruptions, or capacity constraints reduce available supply; prices rise even without stronger demand.

4) **Monetary conditions & credit growth:** If money/credit expands faster than real output for long enough—often via very accommodative monetary policy—demand can outstrip supply and inflation can become entrenched.

5) **Inflation expectations (persistence):** If people and firms expect higher inflation, they set wages and prices accordingly, risking a **wage–price spiral** that keeps inflation going.
